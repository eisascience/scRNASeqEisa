...
CTL_Immune_GeneList <- function(QuickGO.path="./data/QuickGO"){
  ...
  SGS.LS$CD4Canonical2 <- c("CD4", "FOXP3", "IL2RA", "IL7R", "LDHB", "RPS12")
  SGS.LS$NKCanonical <- c("GZMK", "LYAR", "NKG7", "GZMA", "GNLY", "GZMH")
  SGS.LS$NKCanonical2 <- c("NCAM1", "FCGR3", "FGFBP2", "SPON2", "PRF1", "XCL2", "GNLY", "GZMB", "CLIC3", "AKR1C3", "GZMA", "CD8A", "NKG7", "KLRB1")
  SGS.LS$MAITCanonical <- c("CD8A", "CD8B", "KLRB1", "DPP4")
  SGS.LS$MonocyteCanonical <- c("CD14", "FCGR1A", "CD68", "S100A12", "MS4A7", "CKB", "LILRA3")
  SGS.LS$DendriticCanononical <-c("IL3RA", "CD1C", "BATF3", "THBD", "CD209", "FCER1A", "SERPINF1", "CLEC10A")
  SGS.LS$MegakaryocyteCanonical <-c("GP9", "ITGA2B", "TMEM40", "LY6G6F","SEPT5", "PTCRA", "TREML1", "CLDN5")
